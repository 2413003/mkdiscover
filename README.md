...
1. **Production must contain no fake or demo listings.**
2. **All user-facing pages must follow the Apple/Google-level simplicity standard in `DESIGN_SYSTEM.md`.**
...
UI direction is strict: minimal text, clear visual hierarchy, one primary action per screen, and instant comprehension for first-time users.
...
- `DESIGN_SYSTEM.md` - page styling law for all user-facing UI
